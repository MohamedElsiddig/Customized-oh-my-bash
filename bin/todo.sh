...
TODOTXT_CFG_FILE=${TODOTXT_CFG_FILE:-$OSH/cache/.todo/config}
...
[ -e "$TODOTXT_CFG_FILE" ] || {
    CFG_FILE_ALT="$OSH/cache/todo.cfg"
...
[ -e "$TODOTXT_CFG_FILE" ] || {
    CFG_FILE_ALT="${XDG_CONFIG_HOME:-$OSH/cache/.config}/todo/config"
...
[ -d "$TODO_ACTIONS_DIR" ] || {
    TODO_ACTIONS_DIR_ALT="${XDG_CONFIG_HOME:-$OSH/cache/.config}/todo/actions"
