cite about-plugin
about-plugin 'initialize fasd "Fasd offers quick access to files and directories for POSIX shells (see https://github.com/clvv/fasd)"'
