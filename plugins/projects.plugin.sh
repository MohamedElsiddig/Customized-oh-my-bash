...
#Automatically enable projects completion

# _OSH-component-item-is-enabled completion projects
...
# 		echo ""
# 		echo -e "$echo_bold_green Enabling projects plugin completion${echo_normal}"
# 		sleep 1
# 		_enable-completion projects
