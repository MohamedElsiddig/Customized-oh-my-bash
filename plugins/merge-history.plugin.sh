...
# Official repository https://github.com/pts/pts-merge-history-bash

#########################################

cite about-plugin 
about-plugin 'Merge bash history lines just like zsh merge_history'
